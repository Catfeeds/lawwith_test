...
<link rel="stylesheet" href="/Public/Date_tool/dateSelect.css">
<script type="text/javascript" src="/Public/Date_tool/dateSelect.js"></script>
<!--<link rel="stylesheet" href="/Public/Admin/css/bootstrap.css"/>-->
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form id="Form2" method="post" class="form-horizontal" action="<?php echo U('Laws/subeditLaws');?>" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-lg-3 control-label">LOGO </label>
                        <div class="col-lg-3">
                            <input id="up_logo" type="file" name="logo" style="display: none" onchange="previewImage(this)"/>
                            <div id="preview">
                                <?php if(empty($laws["logo"])): ?><img id="imghead" src="/Public/Admin/images/default_logo.jpg" title="Logo图片">
                                    <?php else: ?>
                                    <img id="imghead" src="<?php echo ($laws["logo"]); ?>" title="Logo图片"><?php endif; ?>
                            </div>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control" name="lawName" value="<?php echo ($laws["law_name"]); ?>"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                                <select name="province" id="province" onchange="loadRegion('province',2,'city','<?php echo U('Laws/getRegion');?>');">
                                    <option value="0" selected>省份/直辖市</option>
                                    <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$city_vo): $mod = ($i % 2 );++$i; if($laws['province'] == $city_vo['cityname']): ?><option value="<?php echo ($city_vo["id"]); ?>" selected><?php echo ($city_vo["cityname"]); ?></option>
                                        <?php else: ?>
                                            <option value="<?php echo ($city_vo["id"]); ?>"><?php echo ($city_vo["cityname"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <select name="city" id="city"  onchange="loadRegion('city',3,'town','<?php echo U('Laws/getRegion');?>');">
                                    <option value="0">市/县</option>
                                    <?php if(is_array($city)): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$city_vo): $mod = ($i % 2 );++$i; if($laws['city'] == $city_vo['cityname']): ?><option value="<?php echo ($city_vo["id"]); ?>" selected><?php echo ($city_vo["cityname"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <select name="town" id="town">
                                    <option value="0">镇/区</option>
                                    <?php if(is_array($town)): $i = 0; $__LIST__ = $town;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$city_vo): $mod = ($i % 2 );++$i; if($laws['town'] == $city_vo['cityname']): ?><option value="<?php echo ($city_vo["id"]); ?>" selected><?php echo ($city_vo["cityname"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control" name="address" value="<?php echo ($laws["address"]); ?>"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control" name="phone" value="<?php echo ($laws["phone"]); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <select class="form-control" name="uadmin">
                                ...
                                <?php if(is_array($lawyer)): $i = 0; $__LIST__ = $lawyer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lawyer_vo): $mod = ($i % 2 );++$i; if($laws['uadmin'] == $lawyer_vo['id']): ?><option value="<?php echo ($lawyer_vo['id']); ?>" selected><?php echo ($lawyer_vo['uname']); ?>(<?php echo ($lawyer_vo['mobile']); ?>)</option>
                                    <?php else: ?>
                                        <option value="<?php echo ($lawyer_vo['id']); ?>"><?php echo ($lawyer_vo['uname']); ?>(<?php echo ($lawyer_vo['mobile']); ?>)</option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <select class="form-control" id="s2example-2" name="major_id[]" multiple>
                                ...
                                <optgroup label="请选择专业领域">
                                    <?php $_result=explode(',',$laws['majors']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vx): $mod = ($i % 2 );++$i; if(is_array($major_tree)): $i = 0; $__LIST__ = $major_tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$major_vo): $mod = ($i % 2 );++$i; if($major_vo['id'] == $vx): ?><option value="<?php echo ($major_vo['id']); ?>" selected><?php echo ($major_vo["delimiter"]); echo ($major_vo["major_name"]); ?></option>
                                                <?php else: ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control" id="date11" name="create_time" value="<?php echo (date('Y-m-d',$laws['create_at'])); ?>"/>
                            <script type="text/javascript">
                                $("#date11").dateSelect();
                            </script>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <textarea class="form-control autogrow" name="describe" placeholder="描述律所" style="min-height: 100px;"><?php echo ($laws["profile"]); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <?php if($laws['status'] == 1): ?><input type="checkbox" name="status" class="iswitch iswitch-info" checked="checked" value="1">
                                <?php else: ?>
                                <input type="checkbox" name="status" class="iswitch iswitch-info" value="1"><?php endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-9 col-lg-offset-3">
                            <input type="hidden" name="lid" value="<?php echo ($laws["id"]); ?>"/>
                            <input type="hidden" name="logo_path" value="/Uploads/<?php echo ($laws["logo"]); ?>"/>
