...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-body form-horizontal">
            <form id="For_video" action="<?php echo U('Live/sendMsg');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="col-lg-6 col-lg-offset-3">
                        ...
                        <input type="hidden" name="id" value="<?php echo ($liveInfo["id"]); ?>">
                        <input type="hidden" name="mobile" value="<?php echo ($liveInfo["mobile"]); ?>">
                    </div>
                </div>
            </form>
        </div>
