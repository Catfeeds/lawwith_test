...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-body form-horizontal">
            <form id="For_video" action="<?php echo U('Live/chatRoomUpdate');?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-lg-1 control-label">频道名称</label>
                    <div class="col-lg-5 kv-main"><input class="form-control" type="text" name="name" value="<?php echo ($data["name"]); ?>"></div>
                </div>
                <div class="form-group">
                    <label class="col-lg-1 control-label">公&nbsp;&nbsp;&nbsp;&nbsp;告</label>
                    <div class="col-lg-5 kv-main">
                        <textarea name="announcement" class="form-control" cols="" rows="3" id="announcement"><?php echo ($data["announcement"]); ?></textarea>
                        长度限制40个字以内
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-1 control-label">机器人数</label>
                    <div class="col-lg-5 kv-main"><input class="form-control" type="text" name="robot" value="<?php echo ($data["robot"]); ?>"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-5 kv-main">
                        ...
                        <img src="<?php echo ($data["thumb_img"]); ?>" style="width:320px;height:200px" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3">
                        <button type="submit" class="btn btn-success" id="btn-submit">保 存</button>
