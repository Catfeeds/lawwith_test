    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form id="Form2" method="post" class="form-horizontal" action="<?php echo U('Activity/update');?>" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-lg-1 control-label">标题</label>
                        <div class="col-lg-5">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa-quote-left"></i></span>
                                <input type="text" name="title" class="form-control" value="<?php echo ($info["title"]); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-1 control-label">活动封面</label>
                        <div class="col-lg-5">
                            <img src="<?php echo ($info["imgs"]); ?>" style="width: 250px;height: 165px;">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-1 control-label">承办单位</label>
                        <div class="col-lg-5">
                            <input type="text" name="host_unit" class="form-control" value="<?php echo ($info["sponsor"]); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-1 control-label">限制人数</label>
                        <div class="col-lg-2">
                            <div class="input-group spinner" data-step="1">
                                <span class="input-group-btn">
                                    <button class="btn btn-gray" data-type="decrement">-</button>
                                </span>
                                <input type="text" class="form-control text-center" name="numbs" value="<?php echo ($info["number"]); ?>" onkeyup="value=value.replace(/[^\d]/g,'')"/>
                                <span class="input-group-btn">
                    ...
                    <div class="form-group">
                        <label class="col-lg-1 control-label">活动地址</label>
                        <div class="col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-lg-1 control-label">活动群号</label>
                        <div class="col-lg-5">
                            <input type="text" name="group" class="form-control" value="<?php echo ($info["group"]); ?>"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-1 control-label">人均费用</label>
                        <div class="col-lg-3">
                            <div class="input-group">
                                <span class="input-group-addon">¥</span>
                                <input type="text" class="form-control" name="price" onkeyup="value=value.replace(/[^\d]/g,'')" value="<?php echo ($info["price"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" name="event_time" id="field-5" class="form-control daterange" data-time-picker="true" data-time-picker-increment="5" data-format="MM/DD/YYYY h:mm A" value="<?php echo (date('Y-m-d H:i:s',$info["star_time"])); ?>----<?php echo (date('Y-m-d H:i:s',$info["end_time"])); ?>"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-1 control-label">截止时间</label>
                        <div class="col-lg-2">
                            <input type="text" name="deadline" class="form-control calendar calendar-time" data-mask="datetime" value="<?php echo (date('Y-m-d H:i:s',$info["deadline"])); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-1 control-label">内容</label>
                        <div class="col-lg-11">
                            <textarea class="form-control autogrow" name="content" style="height: auto"><?php echo ($remark); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    fields: {
                        title: {
                            ...
                            validators: {
                                ...
                                //                                remote: {
                                //                                    url: "<?php echo U('Content/checkLaws');?>",
                                //                                    message: '律所名不可用'
                                //                                }
                            }
                        },
...
<link rel="stylesheet" href="/Public/Admin/js/daterangepicker/daterangepicker-bs3.css">
