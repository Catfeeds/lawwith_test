                ...
                <div class="panel-body">
                    <table class="table table-bordered table-striped" id="example-2">
                        ...
                        <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
                                <td><?php if(empty($vo["user_name"])): ?>暂未设置用户名<?php else: ?><span class="label label-secondary"><?php echo ($vo["user_name"]); ?></span><?php endif; ?></td>
                                <td><span style="font-weight: bolder"><?php echo ($vo["mobile"]); ?></span></td>
                                <td><span class="label label-secondary" style="font-weight: bolder"><?php echo ($vo['is_actived'] ? '已激活':'未激活'); ?></span></td>
                                <td><?php if(empty($vo["actived_time"])): else: ?><span class="label label-secondary" style="font-weight: bolder"><?php echo (date("Y-m-d H:i:s",$vo["actived_time"])); ?></span><?php endif; ?></td>
                                <td><span class="label label-secondary" style="font-weight: bolder"><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></span></td>
