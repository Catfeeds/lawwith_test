...
class JPush{
    ...
    private $app_key = '92f6a467b8243bcdb82416b0';            //待发送的应用程序(appKey)，只能填一个。
    private $master_secret = '5fe94e0c936e6d755b3afe0a';        //主密码
    ...
    */
    ...
    public function push($platform='all', $receiver='all',$content='',$m_type='',$m_txt='',$m_time=86400){
