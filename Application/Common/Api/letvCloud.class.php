...
class LetvCloud {
    ...
    public $user_unique='dwbppqvkxs';   //dwbppqvkxs
    public $secret_key='1599b6d686f3a60b06295ccdd9c00b3d';  //1599b6d686f3a60b06295ccdd9c00b3d
    ...
    public function videoGetPlayinterface($uu,$vu,$type,$pu="",$auto_play=null,$width=0,$height=0){
        ...
        if($type == "url"){
            ...
            $res = '<script type="text/javascript">var letvcloud_player_conf = '.$jsonString.';</script><script type="text/javascript"
