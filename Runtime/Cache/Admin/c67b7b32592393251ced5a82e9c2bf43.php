...
<div class="page-title">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1">
            ...
            <li>
                <a href="#" onClick="javascript :history.back(-1);">培训管理</a>
            </li>
            <li class="active">
                    ...
                    <header>
                        ...
                        <a class="user-img">
                            <?php if(empty($info['author_info']['icon'])): ?><img src="/Public/Admin/images/user-4.png" alt="user-img" class="img-responsive img-circle" />
                                <?php else: ?>
                                <img src="<?php echo (img_path($info["author_info"]["icon"])); ?>" alt="user-img" class="img-responsive img-circle" /><?php endif; ?>
                        </a>
                        <div class="user-details">
                            <span><strong><?php echo ($info["author"]); ?></strong></span>
                            <time><?php echo (date('Y-m-d H:i',$info["create_at"])); ?></time>
                        </div>

                    </header>
                    <div class="story-content">
                        <div class="story-album">
                            <?php echo ($info["video_path"]); ?>
                        </div>
                        <div class="mail-single-attachments">
                            ...
                            <ul class="list-unstyled list-inline">
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img1"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img2"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img3"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img4"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img5"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img6"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img7"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                                <li>
                                    <a class="thumb">
                                        <img src="<?php echo ($info["imgs_cap"]["img8"]); ?>" class="img-thumbnail" title="视频截图"/>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="mail-single-attachments">
                            <h3><i class="fa-bookmark-o"></i>主讲人</h3>
                            <h4><?php echo ($info["speaker_user"]["uname"]); ?></h4>
                            <div class="mail-single-body">
                                <p><?php echo ($info["speaker_info"]); ?></p>
                            </div>
                        </div>
                        <div class="mail-single-attachments">
                            <h3>
                            ...
                            <ul class="list-unstyled list-inline">
                                <?php if(is_array($major)): $i = 0; $__LIST__ = $major;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$major_vo): $mod = ($i % 2 );++$i; if($major_vo['id'] == $info['tags']): ?><li><span class="label label-warning">#<?php echo ($major_vo["delimiter"]); echo ($major_vo["major_name"]); ?>#</span></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
                        <div class="story-options-links">
                            ...
                            <a>
                                ...
                                Comments
                                <span>(<?php echo ($info["commt_sums"]["counts"]); ?>)</span>
                            </a>
                        </div>
                        ...
                        <ul class="list-unstyled story-comments">
                            <?php if(is_array($info['commt_info'])): foreach($info['commt_info'] as $key=>$info_vo): ?><li>
                                    ...
                                    <div class="story-comment">
                                        ...
                                        <div class="story-comment-content">
                                            <a class="story-comment-user-name">
                                                ...
                                                <time><?php echo (date('Y-m-d H:i',$info_vo["ctime"])); ?></time>
                                            </a>
                                        ...
                                        <div class="story-options-links">
                                            <a>
                                                ...
                                                Like
                                                <span>(<?php echo ((isset($info_vo["likes"]) && ($info_vo["likes"] !== ""))?($info_vo["likes"]):0); ?>)</span>
                                            </a>

                                            <a>
                                                <i class="el-thumbs-down"></i>
                                                dislike
                                                <span>(<?php echo ((isset($info_vo["dislikes"]) && ($info_vo["dislikes"] !== ""))?($info_vo["dislikes"]):0); ?>)</span>
                                            </a>

                                            <a href="<?php echo U('Content/del_comment',array('t'=>lx_encrypt(3),'cid'=>lx_encrypt($info_vo['id'])));?>" onclick="return del_confirm()">
                                                <i class="el-trash"></i>
                                                delete
                                            </a>
                                        </div>
