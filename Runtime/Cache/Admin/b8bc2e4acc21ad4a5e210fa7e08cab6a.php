...
<div class="page-title">
    ...
    <div class="breadcrumb-env">
        <ol class="breadcrumb bc-1">
            ...
            <li>
                <a href="#" onClick="javascript :history.back(-1);">视频分类管理</a>
            </li>
            <li class="active">
...
<div class="row">
    <div class="panel panel-default">
        <div class="panel-body form-horizontal">
            <form id="For_video" action="<?php echo U('Video/categoryCreate');?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-lg-3 control-label">分类标题</label>
                    <div class="col-lg-5 kv-main"><input class="form-control" type="text" name="cate_name" placeholder="分类标题"></div>
                </div>
                <div class="form-group">
                    <label class="col-lg-3 control-label">排序</label>
                    <div class="col-lg-5 kv-main"><input class="form-control" type="text" name="sort" placeholder="排序id"></div>
                </div>
                <div class="form-group">
                    <label class="col-lg-3 control-label">显示</label>
                    <div class="col-lg-5">
