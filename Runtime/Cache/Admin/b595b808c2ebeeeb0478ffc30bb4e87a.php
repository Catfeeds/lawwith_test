    ...
    <!--</div>-->
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-counter" data-count=".num" data-from="0" data-to="<?php echo ($laws); ?>" data-duration="2">
                    <div class="xe-icon">
                        <i class="fa-institution"></i>
                    </div>
                    <div class="xe-label">
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-counter xe-counter-blue" data-count=".num" data-from="1" data-to="<?php echo ($accounts); ?>" data-duration="3" data-easing="false">
                    <div class="xe-icon">
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-counter xe-counter-danger" data-count=".num" data-from="1" data-to="<?php echo ($posts); ?>" data-duration="4" data-easing="true">
                    <div class="xe-icon">
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-counter xe-counter-pink" data-count=".num" data-from="0" data-to="<?php echo ($helps); ?>" data-decimal="," data-duration="5" data-easing="true" data-delay="1">
                    <div class="xe-icon">
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-vertical-counter xe-counter-block" data-count=".num" data-from="0" data-to="<?php echo ($laws); ?>" data-decimal="," data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa-institution"></i>
                    </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-counter-block xe-counter-block-blue" data-count=".num" data-from="0" data-to="<?php echo ($accounts); ?>" data-duration="4" data-easing="false">
                    <div class="xe-upper">
                    ...
                    <div class="xe-lower">
                        ...
                        <span>律师&nbsp;&nbsp;<?php echo ($lawyers); ?></span>
                        <span>法务&nbsp;&nbsp;<?php echo ($justices); ?></span>
                        <span>学者&nbsp;&nbsp;<?php echo ($scholars); ?></span>
                        <span>游客&nbsp;&nbsp;<?php echo ($tourists); ?></span>
                        <span>其他&nbsp;&nbsp;<?php echo ($other); ?></span>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-danger" data-count=".num" data-from="0" data-to="<?php echo ($posts); ?>" data-decimal="," data-duration="3">
                    <div class="xe-icon">
                        <i class="linecons-doc"></i>
                    </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-pink" data-count=".num" data-from="0" data-to="<?php echo ($helps); ?>" data-decimal="," data-duration="3">
                    <div class="xe-icon">
                        <i class="linecons-heart"></i>
                    </div>
                    <div class="xe-label">
                        <strong class="num">0,0</strong>
                        <span>求助总数</span>
                        <span>昨日发帖数&nbsp;&nbsp;<?php echo ($question); ?></span>
                    </div>
                </div>
